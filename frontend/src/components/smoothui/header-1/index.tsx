...
export function HeroGrid() {
  ...
  return (
    <div className="relative ">
      <MainHeader />
      <main>
        <section className="relative min-h-[calc(100vh-(--spacing(14)))] overflow-hidden py-36">
          ...
          >
            <div>
              ...
              >
                Run your business smoother with {" "}
                <span className="text-brand">CoffeePOS</span>
              </AnimatedText>
              <AnimatedText
                as="p"
                ...
                delay={0.15}
              >
                COFFEE POS gives you the power to manage your business payments and sales efficiently 
              </AnimatedText>
            </div>
            <AnimatedGroup
            ...
            >
              <Button
                className="shadow transition-shadow hover:shadow border-t"
                variant="secondary"
